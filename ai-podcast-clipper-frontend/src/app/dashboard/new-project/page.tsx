...
export default function NewProjectPage() {
  ...
  const processYouTubeVideo = async (url: string): Promise<void> => {
    try {
      ...
      setProcessingStatus({
        step: "complete",
        message: `Successfully processed ${result.clips_processed ?? 0} clips!`,
        progress: 100,
      });
                ...
                <form onSubmit={handleUrlSubmit} className="space-y-6">
                  ...
                  <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                    ...
                    <ul className="list-inside list-disc space-y-1 text-sm text-blue-800">
                      ...
                      <li>
                        You&apos;ll configure how to split the video into chunks
                      </li>
                      <li>Each chunk will be processed for optimal learning</li>
                    </ul>
                  </div>
                ...
                <form onSubmit={handleUrlSubmit} className="space-y-6">
                  ...
                  <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                    ...
                    <ul className="list-inside list-disc space-y-1 text-sm text-purple-800">
                      <li>We&apos;ll analyze your file and extract metadata</li>
                      <li>
          ...
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
            ...
            <div className="space-y-2 text-sm text-yellow-700">
              ...
              <div>
                ...
                {chunkConfig.minutesPerChunk > 0 && chunkConfig.totalChunks > 0
                  ? "✅ Yes"
                  : "❌ No"}
              </div>
            </div>
